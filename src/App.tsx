...
function App() {
  ...
  const weekCategoryTotals = useMemo(
    () => calculateCategoryTotals(weekIncomes, weekTransfers, data.settings),
    [data.settings, weekIncomes, weekTransfers],
  );
  const weekRemittanceRows = useMemo(
    () => calculateRemittance(weekCategoryTotals, data.settings),
    [weekCategoryTotals, data.settings],
  );
        ...
        <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          {view === 'month' && selectedMonth && (
            <MonthView
              ...
              weekTotals={weekCategoryTotals}
              weekRemittanceRows={weekRemittanceRows}
...
function MonthView(props: {
  ...
  weekRemittanceRows: ReturnType<typeof calculateRemittance>;
  totals: Record<string, number>;
  remittanceRows: ReturnType<typeof calculateRemittance>;
  parishes: Parish[];
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <div className="space-y-5">
          ...
          <WeeklySummarySection
            ...
            totals={props.weekTotals}
            remittanceRows={props.weekRemittanceRows}
          />
        </div>
      </section>
...
function WeeklySummarySection({
  ...
  return (
    <section className="panel overflow-hidden">
      <div className="border-b border-stone-200 p-4">
        <h3 className="text-lg font-bold">Week {activeWeek} Summary</h3>
      </div>
      <div className="max-h-[560px] overflow-auto">
        <table className="w-full border-collapse">
          <thead className="table-head">
